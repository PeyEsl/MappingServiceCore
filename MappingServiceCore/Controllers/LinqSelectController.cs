...
namespace MappingServiceCore.Controllers
{
    public class LinqSelectController : Controller
    {
        ...
        private readonly LinqSelectConfig _linqSelectConfig;

        public LinqSelectController(
            IMappingService mappingService,
            LinqSelectConfig linqSelectConfig)
        {
            _mappingService = mappingService;
            _linqSelectConfig = linqSelectConfig;
        }

        #endregion

        // GET: LinqSelect
        [Route("linq-select-list")]
        public async Task<IActionResult> Index(string? searchQuery)
        {
            try
            {
                ...
                var peopleDto = _linqSelectConfig.MapEntitiesToDtos(person)
                             ?? new List<PersonDto>();

                var peopleList = _linqSelectConfig.MapDtosToViewModels(peopleDto)
        ...
        // GET: LinqSelect/Create
        [Route("linq-select-add")]
        public IActionResult Create()
        {
            return View();
        }

        // POST: LinqSelect/Create
        [HttpPost]
        [Route("linq-select-add")]
        ...
        public async Task<IActionResult> Create(PersonViewModel model)
        {
            ...
            try
            {
                ...
                var personDto = _linqSelectConfig.MapViewModelToDto(model);

                personDto.CreateDate = DateTime.Now.ToString();

                var personEntity = _linqSelectConfig.MapDtoToEntity(personDto);
        ...
        // GET: LinqSelect/Details/5
        [Route("linq-select-detail")]
        public async Task<IActionResult> Details(string? id)
        {
            ...
            try
            {
                ...
                var personDto = _linqSelectConfig.MapEntityToDto(personEntity);

                var personVm = _linqSelectConfig.MapDtoToViewModel(personDto);
        ...
        // GET: LinqSelect/Edit/5
        [Route("linq-select-update")]
        ...
        // GET: LinqSelect/Delete/5
        [Route("linq-select-remove")]
